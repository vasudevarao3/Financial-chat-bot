...
from rag_pinecone import RAGApplication
...
class Dashboard:
    ...
    #     if not self.history_collection.find_one({"user_id": user_id}):
    #         self.history_collection.insert_one({"user_id": user_id, "history": []})
    ...
    def initialize_history(self, user_id):
        ...
        #       user_id: id,
        #       history : {
        #               {session_id: 1, conversation: [you, ai, you, ai, you, ai] },
        #               {session_id: 2, conversation: [you, ai] },
        #               {session_id: 3, conversation: [you, ai] }
        #      },
        # } 
    ...
    def show(self):
        ...
        if st.button("Submit") and query.strip():
            ...
            relavent_documents, rewritten_query = rag.run_query(query, conversation_history)
